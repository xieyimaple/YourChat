...
import cn.rongcloud.imlib.react.custom.ContactMessage;
import cn.rongcloud.imlib.react.custom.CustomImageMessage;
import cn.rongcloud.imlib.react.custom.CustomRecallNotificationMessage;
import cn.rongcloud.imlib.react.custom.CustomVideoMessage;
import cn.rongcloud.imlib.react.custom.GroupAnnounceMessage;
import cn.rongcloud.imlib.react.custom.GroupApplyMessage;
import cn.rongcloud.imlib.react.custom.GroupClearMessage;
import cn.rongcloud.imlib.react.custom.GroupMuteMessage;
import cn.rongcloud.imlib.react.custom.PokeMessage;
import cn.rongcloud.imlib.react.custom.RedPacketGrabMessage;
import cn.rongcloud.imlib.react.custom.RedPacketsMessage;
import cn.rongcloud.imlib.react.custom.SealGroupConNtfMessage;
import cn.rongcloud.imlib.react.custom.SealGroupKickMessage;
import cn.rongcloud.imlib.react.custom.SystemNotifyMessage;
import cn.rongcloud.imlib.react.custom.TransferMoneyMessage;
    ...
    if (objectName != null) {
      switch (objectName) {
        ...
        case "RC:GIFMsg"://GIF
          ...
          break;
        case "KK:image"://自定义image
          messageContent = CustomImageMessage.obtain(map.getString("url"));
          break;
        case "RC:CardMsg"://自定义image
          messageContent = ContactMessage.obtain(map.getString("Id"),
            map.getString("Name"), map.getString("imgUrl"), map.getString("sendUserId"), map.getString("sendUserName"), map.getString("extra"));
          break;
        case "RC:RcNtf"://
          messageContent = new CustomRecallNotificationMessage(map.getString("mOperatorId"), Long.valueOf(map.getString("mRecallTime")), map.getString("mOriginalObjectName"), map.getBoolean("mAdmin"), map.getBoolean("mDelete"), map.getString("recallContent"), Long.valueOf(
            map.getString("recallActionTime")));
          break;
        case "Custom:video"://
          messageContent = CustomVideoMessage.obtain(map.getString("url"));
          break;
        case "Jy:GrpAnnounce"://非发送信息
//          messageContent = GroupAnnounceMessage.obtain(map.getString("url"));
//          if (map.hasKey("extra")) {
//            ((CustomImageMessage) messageContent).setExtra(map.getString("extra"));
//          }
          break;
        case "ST:GrpApply"://？？？
          messageContent = GroupApplyMessage.obtain(map.getString("operatorUserId"), map.getString("operation"), map.getString("data"), null);
          break;
        case "ST:MsgClear"://清除信息
          messageContent = GroupClearMessage.obtain(null, null, Long.valueOf(map.getString("clearTime")), null);
          break;
        case "Jy:GrpMute"://非发送信息
//          messageContent = GroupMuteMessage.obtain(map.getString("url"));
//          if (map.hasKey("extra")) {
//            ((CustomImageMessage) messageContent).setExtra(map.getString("extra"));
//          }
          break;
        case "ST:PokeMsg"://
          messageContent = PokeMessage.obtain(map.getString("content"));
          break;
        case "KK:Grabpack":// 非发送信息
//          messageContent = RedPacketGrabMessage.obtain(map.getString("url"));
////          if (map.hasKey("extra")) {
////            ((CustomImageMessage) messageContent).setExtra(map.getString("extra"));
////          }
          break;
        case "KK:redPacket"://红包
          messageContent = RedPacketsMessage.obtain(map.getString("content"),map.getString("redId"));
          break;
        case "ST:ContactNtf"://空 主要用下面那个
//          messageContent = CustomImageMessage.obtain(map.getString("url"));
////          if (map.hasKey("extra")) {
////            ((CustomImageMessage) messageContent).setExtra(map.getString("extra"));
////          }
          break;
        case "ST:ConNtf":// 不知道是什么消息
          messageContent = SealGroupConNtfMessage.obtain(map.getString("operatorUserId"),map.getString("operation"));
          break;
        case "ST:GrpKickedNtf":// 非发送消息
//          messageContent = SealGroupKickMessage.obtain(map.getString("operatorUserId"),map.getString("operation"));
          break;
        case "ST:GrpNtf":// 空
//          messageContent = SealGroupNotificationMessage.obtain(map.getString("operatorUserId"),map.getString("operation"));
          break;
        case "Jy:updateRemarksNotify"://后台发 前端只对比
//          messageContent = SystemNotifyMessage.obtain(map.getString("operatorUserId"),map.getString("operation"));
          break;
        case "KK:transMoney"://转账
          messageContent = TransferMoneyMessage.obtain(map.getString("text"),map.getString("money"));
          break;
      }
    }
