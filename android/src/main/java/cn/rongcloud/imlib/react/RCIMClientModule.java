...
import cn.rongcloud.imlib.react.custom.SealContactNotificationMessage;
import cn.rongcloud.imlib.react.custom.SealGroupKickMessage;
import cn.rongcloud.imlib.react.custom.SealGroupNotificationMessage;
 ...
 */
  ...
  public void init(String key) {
    ...
    List<Class<? extends MessageContent>> mList = new ArrayList<>();
    mList.add(CustomImageMessage.class);
    mList.add(CustomRecallNotificationMessage.class);
    mList.add(CustomVideoMessage.class);
    mList.add(GroupAnnounceMessage.class);
    mList.add(GroupApplyMessage.class);
    mList.add(GroupClearMessage.class);
    mList.add(GroupMuteMessage.class);
    mList.add(PokeMessage.class);
    mList.add(RedPacketsMessage.class);
    mList.add(RedPacketGrabMessage.class);
    mList.add(SealContactNotificationMessage.class);
    mList.add(SealGroupKickMessage.class);
    mList.add(SealGroupNotificationMessage.class);
    mList.add(SystemNotifyMessage.class);
    mList.add(TransferMoneyMessage.class);
    mList.add(ContactMessage.class);
    RongIMClient.getInstance().registerMessageType(mList);
  }
